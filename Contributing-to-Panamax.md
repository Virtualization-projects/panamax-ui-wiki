Panamax is comprised of several git repos: [panamax-ui](https://github.com/CenturyLinkLabs/panamax-ui), [panamax-api](https://github.com/CenturyLinkLabs/panamax-api), [panamax-remote-agent](https://github.com/CenturyLinkLabs/panamax-remote-agent), and [panamax-coreos](https://github.com/CenturyLinkLabs/panamax-coreos). See the [Panamax Architecture page](https://github.com/CenturyLinkLabs/panamax-ui/wiki/architecture) for more info. 
